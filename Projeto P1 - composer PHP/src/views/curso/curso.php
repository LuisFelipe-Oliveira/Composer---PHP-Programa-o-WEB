...
<body>
  <main class="container">
    <h1>Cursos</h1>
    <a href="/curso/inserir" class="btn btn-success mt-3">Novo Curso</a>
      ...
      <tbody>
        ...
        while ($r = $resultado->fetch(PDO::FETCH_ASSOC)) {
          ...
          <tr>
            ...
            <td><?= $r['descricao'] ?></td>
            <td>
              <a href="/curso/alterar/id/<?= $r['idCurso'] ?>" class="btn btn-primary">
                Alterar
              </a>
              <a href="/curso/excluir/id/<?= $r['idCurso'] ?>" class="btn btn-danger">
                Excluir
              </a>
            </td>
          </tr>
