...
<body>
  <main class="container">
    <h1>Alunos</h1>
    <a href="/aluno/inserir" class="btn btn-success mt-3">Novo Aluno</a>
      ...
      <tbody>
        ...
        while ($r = $resultado->fetch(PDO::FETCH_ASSOC)) {
          ...
          <tr>
            ...
            <td><?= $r['idTurma'] ?></td>
            <td>
              <a href="/aluno/alterar/id/<?= $r['idAluno'] ?>" class="btn btn-primary">
                Alterar
              </a>
              <a href="/aluno/excluir/id/<?= $r['idAluno'] ?>" class="btn btn-danger">
                Excluir
              </a>
            </td>
          </tr>
