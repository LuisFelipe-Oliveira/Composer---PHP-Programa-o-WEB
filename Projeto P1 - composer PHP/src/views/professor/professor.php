...
<body>
  <main class="container">
    <h1>Professores</h1>
    <a href="/professor/inserir" class="btn btn-success mt-3">Novo Porfessor</a>
      ...
      <tbody>
        ...
        while ($r = $resultado->fetch(PDO::FETCH_ASSOC)) {
          ...
          <tr>
            ...
            <td><?= $r['idTurma'] ?></td>
            <td>
              <a href="/professor/alterar/id/<?= $r['idProfessor'] ?>" class="btn btn-primary">
                Alterar
              </a>
              <a href="/professor/excluir/id/<?= $r['idProfessor'] ?>" class="btn btn-danger">
                Excluir
              </a>
            </td>
          </tr>
